<template>
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="examId" label="考试id" header-align="center" align="center"></el-table-column>
			...
			<el-table-column prop="score" label="成绩" header-align="center" align="center"></el-table-column>
